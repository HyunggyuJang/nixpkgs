        ...
        changelog =
          {
            ...
            "macport" = "https://github.com/jdtsmith/emacs-mac/blob/emacs-mac-30_1_exp/NEWS-mac";
          }
          .${variant};
...
in
{
  ...
  emacs30-macport = import ./make-emacs.nix (mkArgs {
    ...
    version = "30.2.50";
    variant = "macport";
    rev = "ef4f2f150b435b4b391b7560d95161f679a5ee50";
    hash = "sha256-dDkKSUfxPCWiF+MXQBY21npjZ6LZL6IG6GPx5AptegI=";
  });
}
